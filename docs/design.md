...
| bash-commons | ログ、入力検査、配列操作、文字列操作、ファイル操作、管理者実行、OS別利用者管理、AWS操作の責務分割を参照します。 | [bash-commonsの関数選定](references/bash-commons.md)に、一般基盤29関数と任意AWSモジュール24関数の契約を記載します。 |
